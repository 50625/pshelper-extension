...
class Popup extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  setKeywordIsToggled(flag) {
    this.setState(() => {
      ...
      chrome.extension.getBackgroundPage().console.log(this.state); // chrome.tab.executeScript(null,{code:"document.body.bgColor='red'"});
...
//# sourceMappingURL=index.834c56f7.df0e638806fb414dc6fb.hot-update.js.map